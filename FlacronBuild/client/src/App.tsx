  ...
  return (
    <footer className="relative w-full bg-gradient-to-b from-[#171D25] via-gray-950 to-black text-gray-400 border-t border-gray-800 py-14 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-6">
        ...
        {/* Legal links */}
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs md:text-sm text-gray-400">
          <a href="/privacy" className="hover:text-orange-500 transition-colors">Privacy Policy</a>
          <span className="text-gray-600">·</span>
          <a href="/terms" className="hover:text-orange-500 transition-colors">Terms & Conditions</a>
          <span className="text-gray-600">·</span>
          <a href="/cookies" className="hover:text-orange-500 transition-colors">Cookie Policy</a>
          <span className="text-gray-600">·</span>
          <a href="/disclaimer" className="hover:text-orange-500 transition-colors">Disclaimer</a>
          <span className="text-gray-600">·</span>
          <a href="/refund-policy" className="hover:text-orange-500 transition-colors">Refund & Cancellation</a>
        </div>
...
const LEGAL_PATHS = ["/privacy", "/terms", "/cookies", "/disclaimer", "/refund-policy"];
