import iicompair from '../../../pages/compairPage';
...
export const icompairObj = new iicompair()
...
describe('Compare Estimates — Insurance', () => {
      ...
      cy.wait(100)
        ...
        //now create an other project for compair
          ...
          //  Enter and SAVE Project Name
           ...
           //  Enter and SAVE Project Name
          const projectName1 = generateShortUniqueCompanyName('TestTwo');  
...
loginObj.clickLogout();
 ...
 //  Enter and SAVE Project Name
const projectName = generateShortUniqueCompanyName('TestThree')
      step1Obj.enterProjectName(projectName)
               cy.wrap(projectName).as('savedProjectName')
 ...
 //  Enter and SAVE Project Name
const projectName1 = generateShortUniqueCompanyName('Testfour')
      step1Obj.enterProjectName(projectName1)
               cy.wrap(projectName1).as('savedProjectName2')
...
cy.wait(2000); // Give the comparison page time to render both cards
  ...
  it('TC-04 — Back navigation', { retries: 2 },() => {
    cy.wait(2000)
     ...
     icompairObj.searchProject("TestOne_R3J3X");
 
    cy.wait(500)
     icompairObj.selectProject()
     cy.wait(2000)
    icompairObj.openComparePage();
     icompairObj.searchProject("TestTwo_ZQC1U");
     icompairObj.selectProject()
     cy.wait(1000)
