import ccompair from '../../../pages/compairPage';
...
export const ccompairObj = new ccompair()
...
describe('Compare Estimates — Constructor', () => {
  ...
  const projectName = generateShortUniqueCompanyName('TestOne');
        ...
        //now create an other project for compair
          ...
          //  Enter and SAVE Project Name
               ...
               const projectName1 = generateShortUniqueCompanyName('Test2');
                    ...
                    cy.wrap(projectName).as('savedProjectName2')
    ...
    ccompairObj.openComparePage();
             cy.wait(1000) 
    ccompairObj.openComparePage();
     ccompairObj.searchProject(projectName);
  //  homecompairObj.filterByDate()
    cy.wait(500)
     ccompairObj.selectProject()
     cy.wait(2000)
    ccompairObj.openComparePage();
     ccompairObj.searchProject(projectName1);
     ccompairObj.selectProject()
     cy.wait(1000)
    
   ccompairObj.clickCompare()
    cy.wait(500)
  ...
  cy.get('@structureType').then(structure1 => {
    cy.get('@savedProjectName2').then(projectName2 => {
      cy.get('@structureType2').then(structure2 => {
       ...
       ccompairObj.validateReportByProject(projectName1, validationSet1);
ccompairObj.validateReportByProject(projectName2, validationSet2);
...
loginObj.clickLogout();
  ...
  it('TC-02 — Invalid search shows message',{ retries: 2 }, () => {
   ...
   cy.wait(1000)
    ccompairObj.openComparePage();
    ccompairObj.searchProject('invalid-project');
    ccompairObj.validateNoResults();
     loginObj.clickLogout();
  });
...
// ... after homecompairObj.clickCompare() ...
cy.wait(2000); // Give the comparison page time to render both cards
    ccompairObj.validatePdfButtons()
    loginObj.clickLogout();
  ...
  it('TC-04 — Back navigation', { retries: 2 },() => {
    cy.wait(2000)
     ...
     ccompairObj.searchProject("Test3_XS5TD");
  //  homecompairObj.filterByDate()
    cy.wait(500)
     ccompairObj.selectProject()
     cy.wait(2000)
    ccompairObj.openComparePage();
     ccompairObj.searchProject("Test3_TL28L");
     ccompairObj.selectProject()
     cy.wait(1000)
