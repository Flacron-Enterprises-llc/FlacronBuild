...
class inspectorRole{
    ...
    weblocators={
        ...
        roleTitle: '.text-lg.font-medium.text-neutral-800',
         inspectorName: '[name="inspectorInfo.name"]',
         licenseNum: '[name="inspectorInfo.license"]',
        ...
        slopeIdentifier: '[name="slopeDamage.0.slope"]',
        slopeIdentifier2: '#\\:r50\\:-form-item',
        damageTypeDropdown: '#\\:r5p\\:-form-item',
        damageSeverity: '#\\:r5r\\:-form-item',
        damageDescription: '#\\:r5t\\:-form-item',
        removeSlopeButton: '.p-6 > .inline-flex',
         ownerNote: '[name="ownerNotes"]',
...
this.enterOwnerNote()
  ...
  cy.log("selecting language")
this.selectLanguageDropdown()
  cy.log("selecting currancy")
  this.selectCurrancyDropdown();
