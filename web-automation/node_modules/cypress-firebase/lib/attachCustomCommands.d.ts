...
import { type TaskNameToParams } from './tasks';
/**
...
declare global {
    namespace Cypress {
        interface Chainable {
             ...
             * cy.authCreateUser()
             */
            authCreateUser: (properties: auth.CreateRequest, tenantId?: string) => Chainable<auth.UserRecord | null>;
            /**
             ...
             */
            createUserWithClaims: (properties: auth.CreateRequest, customClaims?: object | null, tenantId?: string) => Chainable<auth.UserRecord | null>;
            /**
             ...
             * cy.authImportUsers()
             */
            authImportUsers: (...args: TaskNameToParams<'authImportUsers'>) => Chainable<auth.UserImportResult>;
            /**
             ...
             * cy.authListUsers()
             */
            authListUsers: (...args: TaskNameToParams<'authListUsers'>) => Cypress.Chainable<auth.ListUsersResult>;
            /**
             ...
             */
            loginWithEmailAndPassword: (email?: string, password?: string, customClaims?: any, tenantId?: string) => Chainable;
            /**
             ...
             * cy.authGetUser('1234')
             */
            authGetUser: (...args: TaskNameToParams<'authGetUser'>) => Chainable<auth.UserRecord | null>;
            /**
             ...
             */
            authGetUserByEmail: (...args: TaskNameToParams<'authGetUserByEmail'>) => Chainable<auth.UserRecord | null>;
            /**
             ...
             */
            authGetUserByPhoneNumber: (...args: TaskNameToParams<'authGetUserByPhoneNumber'>) => Chainable<auth.UserRecord | null>;
            /**
             ...
             */
            authGetUserByProviderUid: (...args: TaskNameToParams<'authGetUserByProviderUid'>) => Chainable<auth.UserRecord | null>;
            /**
             ...
             */
            authGetUsers: (...args: TaskNameToParams<'authGetUsers'>) => Chainable<auth.GetUsersResult>;
            /**
             ...
             */
            authUpdateUser: (...args: TaskNameToParams<'authUpdateUser'>) => Chainable<auth.UserRecord>;
            /**
             ...
             */
            authSetCustomUserClaims: (...args: TaskNameToParams<'authSetCustomUserClaims'>) => Chainable<null>;
            /**
             ...
             */
            authDeleteUser: (...args: TaskNameToParams<'authDeleteUser'>) => Chainable<null>;
            /**
             * Delete a user from Firebase Auth with either a passed uid or the TEST_UID
             * environment variable
             * @param uid = UID of user to delete
             ...
             */
            authDeleteUsers: (...args: TaskNameToParams<'authDeleteUsers'>) => Chainable<auth.DeleteUsersResult>;
            /**
             ...
             */
            authCreateCustomToken: (...args: TaskNameToParams<'authCreateCustomToken'>) => Chainable<string>;
            /**
             ...
             */
            authCreateSessionCookie: (...args: TaskNameToParams<'authCreateSessionCookie'>) => Chainable<string>;
            /**
             * Verify an ID token
             ...
             */
            authVerifyIdToken: (...args: TaskNameToParams<'authVerifyIdToken'>) => Chainable<auth.DecodedIdToken>;
            /**
             ...
             */
            authRevokeRefreshTokens: (...args: TaskNameToParams<'authRevokeRefreshTokens'>) => Chainable<void>;
            /**
             ...
             */
            authGenerateEmailVerificationLink: (...args: TaskNameToParams<'authGenerateEmailVerificationLink'>) => Chainable<string>;
            /**
             ...
             */
            authGeneratePasswordResetLink: (...args: TaskNameToParams<'authGeneratePasswordResetLink'>) => Chainable<string>;
            /**
             ...
             */
            authGenerateSignInWithEmailLink: (...args: TaskNameToParams<'authGenerateSignInWithEmailLink'>) => Chainable<string>;
            /**
             ...
             */
            authGenerateVerifyAndChangeEmailLink: (...args: TaskNameToParams<'authGenerateVerifyAndChangeEmailLink'>) => Chainable<string>;
            /**
             ...
             */
            authCreateProviderConfig: (...args: TaskNameToParams<'authCreateProviderConfig'>) => Chainable<auth.AuthProviderConfig>;
            /**
             ...
             */
            authGetProviderConfig: (...args: TaskNameToParams<'authGetProviderConfig'>) => Chainable<auth.AuthProviderConfig>;
            /**
             ...
             */
            authListProviderConfigs: (...args: TaskNameToParams<'authListProviderConfigs'>) => Chainable<auth.ListProviderConfigResults>;
            /**
             ...
             */
            authUpdateProviderConfig: (...args: TaskNameToParams<'authUpdateProviderConfig'>) => Chainable<auth.AuthProviderConfig>;
            /**
             ...
             */
            authDeleteProviderConfig: (...args: TaskNameToParams<'authDeleteProviderConfig'>) => Chainable<null>;
        }
    }
}
type CommandNames = 'callRtdb' | 'callFirestore' | 'authCreateUser' | 'createUserWithClaims' | 'authImportUsers' | 'authListUsers' | 'login' | 'loginWithEmailAndPassword' | 'logout' | 'authGetUser' | 'authGetUserByEmail' | 'authGetUserByPhoneNumber' | 'authGetUserByProviderUid' | 'authGetUsers' | 'authUpdateUser' | 'authSetCustomUserClaims' | 'authDeleteUser' | 'authDeleteUsers' | 'deleteAllAuthUsers' | 'authCreateCustomToken' | 'authCreateSessionCookie' | 'authVerifyIdToken' | 'authRevokeRefreshTokens' | 'authGenerateEmailVerificationLink' | 'authGeneratePasswordResetLink' | 'authGenerateSignInWithEmailLink' | 'authGenerateVerifyAndChangeEmailLink' | 'authCreateProviderConfig' | 'authGetProviderConfig' | 'authListProviderConfigs' | 'authUpdateProviderConfig' | 'authDeleteProviderConfig';
